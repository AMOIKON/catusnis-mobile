...
class _DeploymentFormScreenState extends State<DeploymentFormScreen> {
  ...
  Future<void> _init() async {
    ...
    if (_isEdit) {
      ...
      // ✅ Fallback : date du jour si non renseignée
      _dateRecep ??= DateTime.now();
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(
          _isEdit ? 'Modifier déploiement' : 'Nouveau déploiement',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _SectionTitre(
                      titre: 'Localisation', icone: Icons.location_on_outlined),
                  _Carte(children: [
                  ...
                  // ── Section 3 : Application & Partenaires ─────────
                  _SectionTitre(
  ...
  Future<void> _soumettre(DeploymentFormProvider prov) async {
    ...
    final result = await prov.soumettre(
      _codeCtrl.text.trim(),
      // ✅ Toujours une date — jamais null envoyé au backend
      _dateRecep != null
          ? '${_dateRecep!.year}-'
              '${_dateRecep!.month.toString().padLeft(2, '0')}-'
              '${_dateRecep!.day.toString().padLeft(2, '0')}'
          : null,
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          Container(
            ...
            height: 64,
            decoration:
                BoxDecoration(color: _kGreenLight, shape: BoxShape.circle),
            child: const Icon(Icons.check_circle_outline,
                color: _kGreen, size: 40),
          ),
          const SizedBox(height: 16),
          Text(
            _isEdit ? 'Déploiement mis à jour !' : 'Déploiement créé !',
            style: const TextStyle(
                fontSize: 17, fontWeight: FontWeight.bold, color: _kTextDark),
          ),
            ...
            child: Row(children: [
              ...
              if (widget.ligne.numeroSerieCtrl.text.isNotEmpty)
                Padding(
                  ...
                  child: Text(
                    widget.ligne.numeroSerieCtrl.text,
                    style: const TextStyle(
                        fontSize: 11,
          ...
          child: Row(children: [
            ...
            Text(
              date != null
                  ...
                  : 'Date de réception',
              style: TextStyle(
                  color: date != null ? _kTextDark : _kTextGray, fontSize: 14),
            ),
            const Spacer(),
            if (date != null)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          Expanded(
            child: Text(
              hasVal ? afficher(valeur as T) : label,
              style: TextStyle(
                  fontSize: 14,
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon:
                      const Icon(Icons.search, color: _kTextGray, size: 20),
                        ...
                        return Material(
                          ...
                          child: ListTile(
                            leading: Icon(widget.icone,
                                size: 18, color: sel ? _kGreen : _kTextGray),
                            ...
                            trailing: sel
                                ...
                                : null,
                            tileColor: sel ? _kGreen.withOpacity(0.05) : null,
